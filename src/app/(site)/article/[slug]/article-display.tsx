  ...
  return (
    <>
      ...
      >
        ...
        {/* Instagram CTA */}
        <div className="mt-14 overflow-hidden rounded-3xl bg-stone-50 p-8 text-center shadow-sm border border-stone-200/60">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white shadow-lg shadow-pink-200/50">
